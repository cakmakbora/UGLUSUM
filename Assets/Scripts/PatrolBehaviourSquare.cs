...
public class PatrolBehaviourSquare : MonoBehaviour
{
    ...
    public float viewAngle = 44f; // 4 derecelik g�r�� a��s�
    public float viewDistance = 10f; // G�r�� mesafesi
    public LayerMask playerMask; // Inspector'da Player layer'�n� se�in
    public Transform eyeOrigin; // G�z pozisyonu (karakterin g�zleri)
